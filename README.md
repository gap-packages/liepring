...
REMARK: this package requires GAP 4.8 (or newer) and the LieRing package.
...
The manual of LiePRing is contained in the `liepring/doc` directory and is
also available at <https://gap-packages.github.io/liepring/>.
